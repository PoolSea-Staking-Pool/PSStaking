...
import "../minipool/PoolseaMinipoolInterface.sol";

interface PoolseaMinipoolManagerInterfaceOld {
    ...
    function createMinipool(address _nodeAddress, MinipoolDeposit _depositType, uint256 _salt) external returns (PoolseaMinipoolInterface);
