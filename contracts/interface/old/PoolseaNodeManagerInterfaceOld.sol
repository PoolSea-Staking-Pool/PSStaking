...
import "../../types/old/NodeDetailsOld.sol";

interface PoolseaNodeManagerInterfaceOld {
    ...
    function getNodeDetails(address _nodeAddress) external view returns (NodeDetailsOld memory);
