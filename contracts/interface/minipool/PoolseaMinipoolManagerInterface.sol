...
interface RocketMinipoolManagerInterface {
    ...
    function createMinipool(address _nodeAddress, uint256 _salt) external returns (PoolseaMinipoolInterface);
    function createVacantMinipool(address _nodeAddress, uint256 _salt, bytes calldata _validatorPubkey, uint256 _bondAmount, uint256 _currentBalance) external returns (PoolseaMinipoolInterface);
