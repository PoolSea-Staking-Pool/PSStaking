...
contract RocketRewardsPoolOld is PoolseaBase, PoolseaRewardsPoolInterfaceOld {
    ...
    */
    ...
    function getPendingRPLRewards() override public view returns (uint256) {
        PoolseaTokenRPLInterface rplContract = PoolseaTokenRPLInterface(getContractAddress("rocketTokenRPL"));
    ...
    */
    ...
    function _executeRewardSnapshot(RewardSubmission calldata _submission) private {
        ...
        PoolseaSmoothingPoolInterface rocketSmoothingPool = PoolseaSmoothingPoolInterface(getContractAddress("rocketSmoothingPool"));
