...
contract PoolseaDAONodeTrustedSettingsMembers is PoolseaDAONodeTrustedSettings, PoolseaDAONodeTrustedSettingsMembersInterface {

    // Construct
    constructor(PoolseaStorageInterface _poolseaStorageAddress) PoolseaDAONodeTrustedSettings(_poolseaStorageAddress, "members") {
        // Set version
        version = 1;
