...
abstract contract PoolseaDAOProtocolSettings is PoolseaBase, PoolseaDAOProtocolSettingsInterface {
    ...
    modifier onlyDAOProtocolProposal() {
        ...
        if(getBool(keccak256(abi.encodePacked(settingNameSpace, "deployed")))) require(getContractAddress("poolseaDAOProtocolProposals") == msg.sender, "Only DAO Protocol Proposals contract can update a setting");
        _;
    }
